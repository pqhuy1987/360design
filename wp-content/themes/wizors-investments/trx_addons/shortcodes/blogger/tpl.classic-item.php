...
?><div id="post-<?php the_ID(); ?>"	<?php post_class( 'sc_blogger_item post_format_'.esc_attr($post_format) ); ?>><?php
	...
	set_query_var('trx_addons_args_featured', array(
		...
		'hover' => 'zoomin',
		'thumb_size' => trx_addons_get_thumb_size($args['columns'] > 2 ? 'serv' : 'serv')
	));
	...
	?><div class="sc_blogger_item_content entry-content"><?php
        ...
        // More button
            ?><div class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($post_link); ?>" class="sc_button sc_button_dark_button sc_button_size_normal"><?php esc_html_e('Read more', 'wizors-investments'); ?></a></div><?php
