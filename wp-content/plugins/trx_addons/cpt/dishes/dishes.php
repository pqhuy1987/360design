...
if ( !function_exists( 'trx_addons_cpt_dishes_get_blog_all_posts_link' ) ) {
	add_filter('trx_addons_filter_get_blog_all_posts_link', 'trx_addons_cpt_dishes_get_blog_all_posts_link');
	function trx_addons_cpt_dishes_get_blog_all_posts_link($link='') {
		if ($link=='') {
...
if (!function_exists('trx_addons_sc_dishes_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('after_setup_theme', 'trx_addons_sc_dishes_add_in_vc', 20);
}
?>