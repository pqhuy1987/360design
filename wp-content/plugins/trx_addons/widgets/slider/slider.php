...
if ( !function_exists( 'trx_addons_sc_widget_slider' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_widget_slider", "trx_addons_sc_widget_slider");
}
...
if ( !function_exists( 'trx_addons_sc_slide' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_slide", "trx_addons_sc_slide");
}
...
if ( !function_exists( 'trx_addons_sc_slider_controller' ) ) {
	...
	if (trx_addons_exists_visual_composer()) add_shortcode("trx_slider_controller", "trx_addons_sc_slider_controller");
}
...
if (!function_exists('trx_addons_sc_widget_slider_add_in_vc')) {
	...
	if (trx_addons_exists_visual_composer()) add_action('after_setup_theme', 'trx_addons_sc_widget_slider_add_in_vc', 20);
}
?>